	...
	<!-- 예약폼 -->
			...
			<h1 align=center>예약이 완료 되었습니다.</h1>
				...
				<div class="shadow p-3 mb-5 bg-body rounded" style="width:700px;" align=left>
					이름
					<div class="shadow-none p-1 mb-3 bg-light rounded">${result.name}</div>
					휴대폰번호
					<div class="shadow-none p-1 mb-3 bg-light rounded">${result.phone }</div>
					장소
					<div class="shadow-none p-1 mb-3 bg-light rounded">${result.resName }</div>
					날짜
					<div class="shadow-none p-1 mb-3 bg-light rounded">${result.rsvDate }</div>
					시간
