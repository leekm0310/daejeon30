...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	<script type="text/javascript">
		...
		function SignUp(){
			...
			var pwo = document.form.passwordOk.value;
			var nm = document.form.name.value;
			var pn = document.form.phone.value;
		...
		<div class="container">
			...
			<div class="col-md-6">
				...
				<div class="col">
					...
					<button type="button" name="btnOverlapped" class="btn btn-danger" style="float:right" onclick="overlap()">중복확인</button>
					<input type="hidden" name="checked_id" value=""> <!-- 왼쪽은 아이디 중복 체크를 위한것임 -->    
				</div>
			...
			<div class="col-md-6">
				...
				<input type="password" class="form-control" id="passwordOk" placeholder="">
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" id="phone" placeholder="'-'을 빼고입력해주세요" name="phone">
			</div>
			<div class="col-md-6">
