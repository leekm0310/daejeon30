...
<div class="row">
	 <div class='col-8 col-md-5'>
    	 <div class="form-group">
			<button type="button" class="btn btn-light">예약요청건</button>
			<button type="button" class="btn btn-light">취소요청건</button>
			<button type="button" class="btn btn-light">예약완료건</button>
			<button type="button" class="btn btn-light">취소완료건</button>
         </div>
     </div>
