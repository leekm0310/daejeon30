...
<body>
 <header>
       ...
       <ul class="list-group list-group-horizontal" style="font-size:25px; color:white;">
    	<li class="list-group-item" style="width:50%; height:120%; background-color:white;"><p class="text-center" style="margin-top:10px">
    	<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="green" class="bi bi-shop-window" viewBox="0 0 16 16">
    	...
    	<strong>신규예약요청</strong>
      	<a href="${contextPath}/admin/allRsv.do" class="count" >${newrm }</a></p></li>
      	
      	
      	<li class="list-group-item" style="width:50%; height:120%;"><p class="text-center" style="margin-top:10px">
