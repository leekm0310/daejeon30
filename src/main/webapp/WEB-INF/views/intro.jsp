	...
	<hr>
		...
		<div class="container">
			...
			<div class="embed-responsive embed-responsive-21by9" align=center>
				<iframe width="1000" height="600" src="https://www.youtube.com/embed/2HeLRDqSgl4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<br>
			<br>
			<div class="row g-0 bg-light position-relative">
